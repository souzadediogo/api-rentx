...
export class CreateFromScratch1651514794518 implements MigrationInterface {
    name = 'CreateFromScratch1651514794518'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "meliAuthCode" ("id" character varying NOT NULL, "meliAuthCode" character varying, CONSTRAINT "PK_f98d77a303395d8634a0749c14b" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "offers" ("id" uuid NOT NULL, "sellerUUID" uuid NOT NULL, "offerTitle" character varying NOT NULL, "offerSubTitle" character varying NOT NULL, "offerUrl" character varying, "offerID" character varying(100) NOT NULL, "skuID" character varying, "status" character varying NOT NULL, "categoryID" character varying NOT NULL, "salesChannel" character varying NOT NULL, "condition" character varying, "free_shipping" boolean, "catalog_listing" boolean, "catalog_product_id" character varying, "listing_type_id" character varying, "offer_created_date" TIMESTAMP NOT NULL DEFAULT now(), "offer_last_updated_date" TIMESTAMP NOT NULL DEFAULT now(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_0e968f6cd9069f6744132c397e1" UNIQUE ("offerID"), CONSTRAINT "PK_4c88e956195bba85977da21b8f4" PRIMARY KEY ("id"))`);
