...
let ListSellerSalesChannelsUseCase = class ListSellerSalesChannelsUseCase {
    constructor(salesChannelsRepository) {
        this.salesChannelsRepository = salesChannelsRepository;
    }
    execute({ sellerUUID, channelName }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            switch (mySwitch) {
                case 'not-ok-not-ok':
                    return yield this.salesChannelsRepository.listAllSalesChannels();
                    break;
                case 'ok-not-ok':
                    return yield this.salesChannelsRepository.listSellerSalesChannels(sellerUUID);
                    break;
                case 'ok-ok':
                    return yield this.salesChannelsRepository.listSellerSalesChannelsByChannelName(sellerUUID, channelName);
                    break;
                case 'not-ok-ok':
                    return yield this.salesChannelsRepository.listAllSalesChannelsByChannelName(channelName);
                    break;
            }
...
ListSellerSalesChannelsUseCase = __decorate([
    (0, tsyringe_1.injectable)(),
    __param(0, (0, tsyringe_1.inject)("SalesChannelsRepository")),
    __metadata("design:paramtypes", [Object])
], ListSellerSalesChannelsUseCase);
