...
let CreateSalesChannelUseCase = class CreateSalesChannelUseCase {
    constructor(salesChannelsRepository) {
        this.salesChannelsRepository = salesChannelsRepository;
    }
    execute({ seller, channelName, sellerNameInChannel, channelSellerID, channelUrl }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.salesChannelsRepository.create({
                seller,
                channelName,
                sellerNameInChannel,
                channelSellerID,
...
CreateSalesChannelUseCase = __decorate([
