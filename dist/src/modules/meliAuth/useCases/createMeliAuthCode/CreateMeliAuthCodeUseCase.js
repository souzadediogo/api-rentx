...
;
let CreateMeliAuthCodeUseCase = class CreateMeliAuthCodeUseCase {
    constructor(meliAuthCodeRepository) {
        this.meliAuthCodeRepository = meliAuthCodeRepository;
    }
    execute({ meliAuthCode }) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.meliAuthCodeRepository.createOrUpdateMeliAuthCode({ meliAuthCode });
        });
    }
};
