...
;
let ListDatapointsByOfferIdAndDaterangeUseCase = class ListDatapointsByOfferIdAndDaterangeUseCase {
    constructor(datapointsRepository) {
        this.datapointsRepository = datapointsRepository;
    }
    execute({ offerid, beginDate, endDate }) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.datapointsRepository
                .listByOfferIdAndDateRange(offerid, beginDate, endDate);
        });
    }
};
ListDatapointsByOfferIdAndDaterangeUseCase = __decorate([
    (0, tsyringe_1.injectable)(),
    __param(0, (0, tsyringe_1.inject)("DatapointsRepository")),
    __metadata("design:paramtypes", [Object])
], ListDatapointsByOfferIdAndDaterangeUseCase);
