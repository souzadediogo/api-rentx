...
let CreateOffersInBatchUseCase = class CreateOffersInBatchUseCase {
    ...
    execute(items) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.offersRepository.createBatch(items);
            // } else {
...
CreateOffersInBatchUseCase = __decorate([
    (0, tsyringe_1.injectable)(),
    __param(0, (0, tsyringe_1.inject)("OffersRepository")),
    __metadata("design:paramtypes", [Object])
], CreateOffersInBatchUseCase);
