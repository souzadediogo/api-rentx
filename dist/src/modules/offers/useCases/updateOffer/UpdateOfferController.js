...
const updateOfferUseCase_1 = require("@modules/offers/useCases/updateOffer/updateOfferUseCase");
...
class UpdateOfferController {
    handle(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const updateOfferUseCase = tsyringe_1.container.resolve(updateOfferUseCase_1.UpdateOfferUseCase);
            yield updateOfferUseCase.execute({
                seller,
                offerTitle,
                offerSubTitle,
                offerUrl,
