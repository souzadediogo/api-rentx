...
class OffersRepository {
  ...
  async listOffersBySkuUUID(skuUUID) {
    // console.log('skuID [repository]', skuUUID)
    const offers = await this.repository.createQueryBuilder().select("offers").from(_Offer.Offer, "offers").andWhere("offers.skuID = :skuID", {
      skuID: skuUUID
