...
var _Distributor = require("../../../../distributors/infra/typeorm/entities/Distributor");
...
let Brand = (_dec = (0, _typeorm.Entity)("brands"), _dec2 = Reflect.metadata("design:type", Function), _dec3 = Reflect.metadata("design:paramtypes", []), _dec4 = (0, _typeorm.PrimaryColumn)('uuid'), _dec5 = Reflect.metadata("design:type", String), _dec6 = (0, _typeorm.Column)(), _dec7 = Reflect.metadata("design:type", String), _dec8 = (0, _typeorm.ManyToMany)(type => _Distributor.Distributor, brands => Brand), _dec9 = Reflect.metadata("design:type", Array), _dec10 = (0, _typeorm.OneToMany)(() => _Sku.Sku, skus => skus.brandName, {
  eager: true,
  nullable: true
}), _dec11 = Reflect.metadata("design:type", Array), _dec12 = (0, _typeorm.CreateDateColumn)(), _dec13 = Reflect.metadata("design:type", typeof Date === "undefined" ? Object : Date), _dec14 = (0, _typeorm.UpdateDateColumn)(), _dec15 = Reflect.metadata("design:type", typeof Date === "undefined" ? Object : Date), _dec(_class = _dec2(_class = _dec3(_class = (_class2 = class Brand {
  //@OneToMany(()=> Distributor, (distributor: Distributor) => distributor.brands) //fk
  constructor() {
    _initializerDefineProperty(this, "id", _descriptor, this);

    _initializerDefineProperty(this, "brandName", _descriptor2, this);

    _initializerDefineProperty(this, "distributors", _descriptor3, this);

    _initializerDefineProperty(this, "skus", _descriptor4, this);
  ...
  writable: true,
  initializer: null
}), _descriptor2 = _applyDecoratedDescriptor(_class2.prototype, "brandName", [_dec6, _dec7], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
}), _descriptor3 = _applyDecoratedDescriptor(_class2.prototype, "distributors", [_dec8, _dec9], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
}), _descriptor4 = _applyDecoratedDescriptor(_class2.prototype, "skus", [_dec10, _dec11], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
  ...
  writable: true,
  initializer: null
})), _class2)) || _class) || _class) || _class); // ID: UID (PK)
// NAME: string
// DISTRIBUTOR: List (FK)
