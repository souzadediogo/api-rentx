...
var CreateUserController = /** @class */function () {
    ...
    CreateUserController.prototype.handle = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, name, username, password, email, created_at, createUserUseCase;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = req.body, name = _a.name, username = _a.username, password = _a.password, email = _a.email, created_at = _a.created_at;
