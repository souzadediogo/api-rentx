...
var CreateUserUseCase = /** @class */function () {
    ...
    CreateUserUseCase.prototype.execute = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        return [4 /*yield*/, this.usersRepository.findByEmail({ email: email })];
                    case 1:
                        userAlreadyExists = _b.sent();
                        if (userAlreadyExists) {
                            throw new AppError_1.AppError("Email ".concat(email, " is already in use!"), 401);
                        }
    ...
    CreateUserUseCase = __decorate([(0, tsyringe_1.injectable)(), __param(0, (0, tsyringe_1.inject)("UsersRepository"))], CreateUserUseCase);
