...
var _listMostRecentDatapointsByOfferIDController = require("../../../../modules/offers/useCases/listMostRecentDatapointByOfferID/listMostRecentDatapointsByOfferIDController");
...
const listDatapointsByOfferIdAndDaterangeController = new _listDatapointsByOfferIdAndDaterangeController.ListDatapointsByOfferIdAndDateController();
const listMostRecentDatapointsByOfferIDController = new _listMostRecentDatapointsByOfferIDController.ListMostRecentDatapointsByOfferIDController(); //ROUTES
//Offers
...
offersRoutes.get("/datapoints/list-most-recent-by-ids", listMostRecentDatapointsByOfferIDController.handle); // offersRoutes.use(ensureAuthenticated);